/* nanomud-plugins-main.c: Contains all main handling code for the plugin system for
 * Nanomud. All loading, unloading and controling of plugins, as well as timing functions
